...
namespace KinematicCharacterController.Walkthrough.NoClipState
{
    public class MyPlayer : MonoBehaviour
    {
        ...
        private void HandleCharacterInput()
        {
            ...
            characterInputs.JumpHeld = ControlFreak2.CF2Input.GetKey(KeyCode.Space);
            ...
            characterInputs.CrouchHeld = ControlFreak2.CF2Input.GetKey(KeyCode.C);
            characterInputs.NoClipDown = ControlFreak2.CF2Input.GetKeyUp(KeyCode.Q);
