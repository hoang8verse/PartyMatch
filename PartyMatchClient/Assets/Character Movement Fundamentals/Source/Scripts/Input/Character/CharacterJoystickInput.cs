...
namespace CMF
{
	...
	public class CharacterJoystickInput : CharacterInput {
        ...
        public override float GetHorizontalMovementInput()
		{
			...
			if(useRawInput)
				_horizontalInput = ControlFreak2.CF2Input.GetAxisRaw(horizontalInputAxis);
			else
				_horizontalInput = ControlFreak2.CF2Input.GetAxis(horizontalInputAxis);
		...
		public override float GetVerticalMovementInput()
		{
			...
			if(useRawInput)
				_verticalInput = ControlFreak2.CF2Input.GetAxisRaw(verticalInputAxis);
			else
				_verticalInput = ControlFreak2.CF2Input.GetAxis(verticalInputAxis);
