...
namespace CMF
{
    ...
    public class CameraJoystickInput : CameraInput
    {
        ...
        {
            //Get input;
			float _horizontalInput = ControlFreak2.CF2Input.GetAxisRaw(joystickHorizontalAxis);
        ...
        {
            //Get input;
			float _verticalInput = ControlFreak2.CF2Input.GetAxisRaw(joystickVerticalAxis);
